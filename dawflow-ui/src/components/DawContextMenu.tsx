...
export interface DawContextMenuItem {
  label: string;
  onClick: () => void;
  shortcut?: string;
  disabled?: boolean;
  separator?: boolean;
  submenu?: DawContextMenuItem[];
}

export interface DawContextMenuProps {
  x: number;
  y: number;
  items: DawContextMenuItem[];
  onClose: () => void;
}
...
/* ------------------------------------------------------------------ */
/*  Render a list of MenuItems                                         */
/* ------------------------------------------------------------------ */

function renderItems(items: DawContextMenuItem[], onClose: () => void): React.ReactNode {
